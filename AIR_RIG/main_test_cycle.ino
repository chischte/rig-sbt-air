void run_main_test_cycle()
{
  ...
  case 2: //pull trigger and start PWM Regulator
    ...
    //***************************************************************************
    if (current_position > (10000 + min_position)
        && current_position - previous_position < 30) ///////////////////WAS 35000+minposition
    ...
    if (cycle_end_indicator == 5) //cycle state is finished
    {
      ...
      cycle_end_indicator = 0;
      if (current_position <= (32000 + min_position)) //previously used: 35000
      {
